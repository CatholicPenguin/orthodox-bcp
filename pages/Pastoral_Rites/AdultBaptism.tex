...
\end{rubric}
\needspace{4\baselineskip}
\elcol{\lett{I}{exorcise} thee, unclean spirit, in the Name of the Father {\ding{64}}, and of the Son {\ding{64}}, and of the Holy {\ding{64}} Ghost. Come forth, depart from this servant of God, \textit{N.}, for he commandeth thee, accursed and damned spirit, he who walked upon the sea and extended his right hand to Peter as he was sinking.}{\lett{E}{xorc\smash{í}zo} te, immúnde spíritus, in nómine Pa {\ding{64}} tris, et Fí {\ding{64}} lii, et Spíritus {\ding{64}} Sancti, ut éxeas, et recédas ab hoc fámulo Dei \textit{N.} Ipse enim tibi ímperat, maledícte damnáte, qui pédibus super mare ambulávit, et Petro mergénti déxteram porréxit.}
\needspace{4\baselineskip}
...
\end{rubric}
\begin{rubric}
    The Priest leads the Catechumen to the Baptistry, where if the water has not been blessed, it is blessed according to the appropriate rite (p. ).
\end{rubric}
\begin{rubric}
